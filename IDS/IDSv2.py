...
def get_cpu_stats() -> dict:
    ...
    per_core   = psutil.cpu_percent(interval=0.1, percpu=True)  # short blocking interval for accurate reading
...
def main():
    ...
    # ── Warm up CPU percent baseline (first call seeds the internal counter) ──
